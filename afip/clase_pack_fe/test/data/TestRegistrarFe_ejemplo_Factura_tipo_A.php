...
//Datos Correspondientes a la factura
    ...
    $DocTipo = 80; //CUIT
    $DocNro = 20260817400; //30661087753  //MSCB //30506919009
    ...
    $ImpTotal = 544.50;
    $ImpTotConc = 0.00;
    $ImpNeto = 450.00; //monto a facturar
    $ImpOpEx = 0.00;
    $ImpIVA = 94.50; //calcula el IVA del monto a facturar
    $ImpTrib = 0.00;
    ...
    $IvaAlicuotaBaseImp = 450.00; //monto a facturar
    $IvaAlicuotaImporte = 94.50;   //calcula el IVA del monto a facturar