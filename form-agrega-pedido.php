...
<?php
if (isset($_GET['ruta'])) {
    $ruta_value = $_GET['ruta'];
} else {
    if ($_SESSION['privilegio']=='repartidor' && empty($_GET['ruta'])) { $ruta_value = '12345678'; }  
    else { $ruta_value='aslkjdhalskdh';} 
}
?>
<input type="hidden" name="ruta" value="<?php echo $ruta_value; ?>">
