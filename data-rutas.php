...
$sql_rutas = "SELECT ruta_histo, fecha_histo FROM histo WHERE venta_histo <> 'PAGO' ORDER BY ruta_histo ASC";
$rs_rutas = mysqli_query($link, $sql_rutas);
...
<div class="col-lg-3 col-6">
    ...
    echo '<p class="resultado"><small><strong>' . $cantidad . '</strong>... ' . $producto . '</small></p>';
            ...
            <a href="ordenar.php?ruta=<?php echo $ruta; ?>">
                <button type="button" class="btn btn-block bg-gradient-success">Orden de Reparto</button>
            </a>  
                     <?php } ?>
