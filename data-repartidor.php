        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Movimientos de Repartidor</h1><br>
<?php 
$sql_repartidor="SELECT * FROM `us` WHERE `id_us` = '{$_GET['id_r']}'";
$rs_repartidor=mysqli_query($link, $sql_repartidor);
$file_repartidor=mysqli_fetch_assoc($rs_repartidor);
$nom_reparte=$file_repartidor['nom_us'];
 ?>
            ...
            <!-- Main content -->
            <?php include 'detalle-repartidor.php'; ?>
            <!-- /.content-wrapper -->
            <br><br>
        ...
        <script>
            $(document).ready(function() {
                $('#example').DataTable({
                    ...
                    "order": [[4, "desc"]] // (((asc))) Ordenar por la segunda columna (índice 1) de forma descendente
                });
            });
        </script>
