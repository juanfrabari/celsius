...
$file_nom_cliente=mysqli_fetch_assoc($rs_nom_cliente);
 ...
 <form action="ruta-temp.php">
                <tr>
                 ...
                 <td><a href="ruta-temp.php?cod=<?php echo $file_pedidos['cod_pedido']; ?>"><input type="submit" class="btn btn-block btn-primary btn-sm" value="Agregar"></a></td>
                </tr>
    </form>
<?php 
 }     ?>
        ...
        $(document).ready(function() {
            $('#example1').DataTable({
                language: {
                    ...
                    //ordena el campo oculto
                    "order": [[1, "asc"]] // Ordenar por la segunda columna (índice 1) de forma descendente
});
});
</script>
        ...
        $(document).ready(function() {
            $('#example').DataTable({
                language: {
                    ...
                    dom: 'Bfrtip',
                    buttons: ['copy', 'csv', 'excel', 'pdf', 'print' ],
                    "order": [[1, "desc"]], // Ordenar por la segunda columna (índice 1) de forma descendente
                    pageLength: 50 // Cambiar el número de resultados por página
});
});
</script>