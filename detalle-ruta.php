...
$sql_ruta = "SELECT *
FROM `histo`
WHERE `ruta_histo` = '{$_GET['ruta']}' 
  AND `venta_histo` IS NOT NULL
  AND `venta_histo` REGEXP '^[0-9]+$'
ORDER BY CAST(`histo`.`venta_histo` AS SIGNED) ASC";
$rs_ruta = mysqli_query($link, $sql_ruta);
$cant = mysqli_num_rows($rs_ruta);
?>
<head>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <!-- Main content -->
            <?php include 'tabla-detalle-ruta.php'; ?>
            <!-- /.content-wrapper -->
            <br><br>
