<!DOCTYPE html>
<html lang="es">
<?php include'session.php'; include'conex.php'; 
if ($_SESSION['privilegio']!='admin') { header('location:salir.php'); }
$sql_clientes="SELECT * FROM `clientes`";$rs_clientes=mysqli_query($link, $sql_clientes);$cant=mysqli_num_rows($rs_clientes);?>
