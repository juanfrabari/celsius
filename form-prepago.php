...
if (isset($_GET['error'])) {
    if ($_GET['error']==1) {
        ?><script type="text/javascript">alert('El producto Seleccionado no exite');</script>    <?php
    }
    # code...
}

// si id_cadena esta vacio es pedido nuevo
...
<?php while ($file_clientes = mysqli_fetch_assoc($rs_clientes)) { ?>
   <option value="<?php echo $file_clientes['nom_cliente']; ?>" data-val="<?php echo $file_clientes['id_cliente']; ?>"><?php echo $file_clientes['nom_cliente']; ?></option>
<?php } ?>
</datalist>
        <?php 
...
// si id_cadena NO ESTA vacio el pedido esta en curso por lo tanto defino la variable $cadenaAleatoria
else
    {
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <?php if (!empty($_GET['id_pedido'])) { ?><script type="text/javascript">alert('Formulario En Desarrollo...');</script>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-danger">
                            ...
                            <div class="card-body">
                                    ...
                                    <form>
                                    <?php } else { ?>
                                   <form action="alta-pedido-temporal.php">
                                    <?php } ?>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <labelfor="exampleInputEmail1">Productos</label>
...
//echo $file_form_pedido_pago['condi_temp'];
 ...
 ?>
                        ...
                        <div class="custom-control custom-radio">
                          ...
                          if ($file_form_pedido_pago['condi_temp']=='Bar') {echo 'checked'; } } ?> required>
                        ...
                        <div class="custom-control custom-radio">
                          ...
                          if ($file_form_pedido_pago['condi_temp']=='Comercio') {echo 'checked'; } }?>>
                        ...
                        <div class="custom-control custom-radio">
                          ...
                          if ($file_form_pedido_pago['condi_temp']=='Eventual') {echo 'checked'; }} ?>>
...
<?php 
if (!empty($_SESSION['id_cadena'])) {
include'form-pedido-previo.php'; 
}
?>
...
function createHiddenInput() {
    ...
    if (opcionSeleccionada) {
        ...
        alert('El Producto ingresado no esta en la Base. 1ro debe darlo de alta. O asegurarse de seleccionarlo de la lista desplegable');
...
function createHiddenInputCliente() {
    ...
    if (opcionSeleccionada) {
        ...
        alert('El Cliente ingresado no esta en la base, Por favor 1ro debe darlo de alta.');
        elementoInput.value = ''; // Limpiamos el valor del input
    }
}
