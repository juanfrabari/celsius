...
<form 
<?php if ($_SESSION['privilegio']=='repartidor') { ?>action="pedido-previo-reparte.php"<?php } else { ?>
action="pedido-previo.php" <?php } ?> >
    <div class="card">
                ...
                <tbody>
                    ...
                    <thead>
                        <tr>
                            <th style="width: 10px"></th>
                            <th>
                                <input type="number" value="0" name="descuento" class="form-control" placeholder="%" id="descuento" min="0" step="1">
                            </th>
...
<script>
  ...
  function calcularTotal() {
    ...
    var descuento = parseFloat(descuentoInput.value) || 0;
     ...
     // Restar el monto del descuento del total original
    var nuevoTotal = <?php echo $total; ?> - descuento;
