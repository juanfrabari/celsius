...
<?php
    ...
    $input_cliente = '<input type="text" name="cliente" class="form-control" id="cliente" placeholder="Nombre de Cliente" list="clientes"  onchange="createHiddenInputCliente()" required autofocus>';
}
...
<body class="hold-transition sidebar-mini">
    ...
    <div class="form-group">
        ...
        <select class="form-control" name="customRadio" required>
            <option value="Bar" <?php if (isset($rs_form_pedido_pago) && $file_form_pedido_pago['condi_temp'] == 'Bar') {
                                        echo 'selected';
                                    } ?>>Bar</option>
            <option value="Comercio" <?php if (isset($rs_form_pedido_pago) && $file_form_pedido_pago['condi_temp'] == 'Comercio') {
                                            echo 'selected';
                                        } ?>>Comercio</option>
            <option value="Eventual" <?php if (isset($rs_form_pedido_pago) && $file_form_pedido_pago['condi_temp'] == 'Eventual') {
                                            echo 'selected';
                                        } ?>>Eventual</option>
        </select>
        <input type="hidden" value="<?php echo $cadenaAleatoria; ?>" name="cadenaAleatoria">
<?php if ($_SESSION['privilegio']=='repartidor') { ?>
        <input type="hidden" name="ruta" value="<?php echo generarCadenaAleatoria(8); ?>">
        <?php } ?>
    </div>
