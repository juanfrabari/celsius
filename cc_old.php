...
<table id="myTable" class="table table-striped projects">
    ...
    <tbody>
        ...
        while ($file_cc = mysqli_fetch_assoc($rs_cc)) {
            ...
            $sql_id_cliente = "SELECT * FROM `clientes` WHERE `id_cliente` = '$id_cliente' ";
            ...
            $sql_histo_cc = "SELECT * FROM `histo` WHERE `cli_histo` LIKE '%$cliente%' AND `venta_histo` IN ('CUENTA CORRIENTE', 'PAGO')";
            ...
            while ($file_pago = mysqli_fetch_assoc($rs_pago)) {
                ...
                if ($file_pago['venta_histo'] === 'PAGO') {

                echo $suma_cc -= $file_pago['monto_histo']; }
            }
        ...
        ?>
                <tr>
                    ...
                    <td><?php echo $suma_cc; ?></td>
                    <td><?php /* Mostrar el pedido si lo tienes disponible */ ?></td>
                </tr>
        <?php
            }
        }
